 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  // WAGGSTER FIX (2026-06-30): disabled so the Z_MIN_PROBE_PIN 19 override below (Z-MAX endstop) is honored. As shipped by dgtaheno this was enabled, which forces the probe onto Z-MIN and breaks Waggster wiring. See docs/configuration-diff.md.
